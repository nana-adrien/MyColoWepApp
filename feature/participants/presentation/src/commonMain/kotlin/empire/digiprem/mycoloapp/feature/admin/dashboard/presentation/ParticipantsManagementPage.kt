...
import empire.digiprem.mycoloapp.core.ui.ParticipantChipStatus
...
import empire.digiprem.mycoloapp.feature.registration.presentation.extension.toUiText
            ...
            if (participants.isEmpty()) {
                ...
                participants.forEachIndexed { index, p ->
                    ...
                    Row(
                        ...
                        Text(p.educationLevel.toUiText().asString(), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant, modifier = Modifier.weight(1.4f))
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        ...
                        Text(p.educationLevel.toUiText().asString(), style = MaterialTheme.typography.labelSmall, color = Primary)
